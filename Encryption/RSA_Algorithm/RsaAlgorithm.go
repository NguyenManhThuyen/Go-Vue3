...
func Encrypt(app *fiber.App) {
	...
	publicKeyFile, err := os.Create("RSA_Algorithm/file/public.pem")
	if err != nil {
	...
	data, err := ioutil.ReadFile("result/input.txt")
	if err != nil {
	...
	err = ioutil.WriteFile("RSA_Algorithm/file/encrypted.bin", encryptedData, 0644)
	if err != nil {
...
func Decrypt (app *fiber.App){
	...
	encryptedData, err := ioutil.ReadFile("RSA_Algorithm/file/encrypted.bin")
	if err != nil {
	...
	err = ioutil.WriteFile("result/decrypted.txt", decryptedData, 0644)
	if err != nil {
