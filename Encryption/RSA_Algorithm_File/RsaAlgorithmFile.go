...
func Encrypt(app *fiber.App) {
	...
	privateKeyFile, err := os.Create("RSA_Algorithm_File/FileTestInput/private.pem")
	if err != nil {
	...
	publicKeyFile, err := os.Create("RSA_Algorithm_File/FileTestInput/public.pem")
	if err != nil {
	...
	outputDir := "RSA_Algorithm_File/FileTestOutput"
